...
# For instance, you could test that shuffle doesn't change the size of the deck, or that the list of cards
# before the shuffle is in a different order than after the shuffle.
